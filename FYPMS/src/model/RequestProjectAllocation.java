...
public class RequestProjectAllocation extends Request{
	...
	@Override
	public boolean approve(Supervisor fyp){
		...
		proj.setSupervisorID(proj.getSupervisorID());
		
		Supervisor supervisor=SupervisorDB.findUserByID(proj.getSupervisorID());
	...
	@Override
	public boolean reject(Supervisor fyp){
